...
abstract class CustomerCustomerFamily implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CustomerFamily\\Model\\Map\\CustomerCustomerFamilyTableMap';
    ...
    /**
     * Initializes internal state of CustomerFamily\Model\Base\CustomerCustomerFamily object.
     */
    ...
    /**
     * Compares this with another <code>CustomerCustomerFamily</code> instance.  If
     * <code>obj</code> is an instance of <code>CustomerCustomerFamily</code>, delegates to
     * <code>equals(CustomerCustomerFamily)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return CustomerCustomerFamily The current object, for fluid interface
     */
    ...
    public function setCustomerId($v)
    {
        ...
        if ($this->customer_id !== $v) {
            $this->customer_id = $v;
            $this->modifiedColumns[CustomerCustomerFamilyTableMap::CUSTOMER_ID] = true;
        }
    ...
    public function setSiret($v)
    {
        ...
        if ($this->siret !== $v) {
            $this->siret = $v;
            $this->modifiedColumns[CustomerCustomerFamilyTableMap::SIRET] = true;
        }
    ...
    public function setVat($v)
    {
        ...
        if ($this->vat !== $v) {
            $this->vat = $v;
            $this->modifiedColumns[CustomerCustomerFamilyTableMap::VAT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CustomerCustomerFamilyTableMap::translateFieldName('CustomerId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CustomerCustomerFamilyTableMap::translateFieldName('Vat', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = CustomerCustomerFamilyTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \CustomerFamily\Model\CustomerCustomerFamily object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCustomerCustomerFamilyQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildCustomerCustomerFamilyQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CustomerCustomerFamilyTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CustomerCustomerFamilyTableMap::CUSTOMER_ID)) {
        ...
        if ($this->isColumnModified(CustomerCustomerFamilyTableMap::VAT)) {
            $modifiedColumns[':p' . $index++]  = 'VAT';
        }

        $sql = sprintf(
            'INSERT INTO customer_customer_family (%s) VALUES (%s)',
    ...
    {
        $pos = CustomerCustomerFamilyTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CustomerCustomerFamily'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CustomerCustomerFamily'][$this->getPrimaryKey()] = true;
        $keys = CustomerCustomerFamilyTableMap::getFieldNames($keyType);
        $result = array(
    ...
    {
        $criteria = new Criteria(CustomerCustomerFamilyTableMap::DATABASE_NAME);
        $criteria->add(CustomerCustomerFamilyTableMap::CUSTOMER_ID, $this->customer_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CustomerFamily\Model\CustomerCustomerFamily (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \CustomerFamily\Model\CustomerCustomerFamily Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCustomer(ConnectionInterface $con = null)
    {
        if ($this->aCustomer === null && ($this->customer_id !== null)) {
            ...
            $this->aCustomer->setCustomerCustomerFamily($this);
        }
    ...
    {
        return (string) $this->exportTo(CustomerCustomerFamilyTableMap::DEFAULT_STRING_FORMAT);
    }
